...
<div class="wrapper row4">
  <div id="quicknav" class="clear">
    <a href="../index.php" ><img src="../../images/back.png" width="110" height="34"  /> </a>|&nbsp;&nbsp;ENGLISH</div>
</div>
<!-- ####################################################################################################### -->
<div class="wrapper row5">
  <div id="container" class="clear"> 
    <!-- ####################################################################################################### --><!-- ############ -->
    <div id="content">
      <div class="imgholder"><img src="../../images/englishlogo.jpg" alt=""  height="215" width="645"/></div>
      <br />

   <?php
   $get=mysql_query("SELECT DISTINCT chapter FROM notes WHERE subject ='English'");
    $option = '';
...
if(isset($_POST['showall']))
  {
  $sql = "SELECT * FROM notes WHERE subject = 'English'";
...
if(isset($_POST['srch']))
{
  ...
  {
  $sql = "SELECT * FROM notes WHERE chapter = '$chpter' AND subject ='English'";
  $rs_result = mysql_query($sql);
  }
}
   ...
   ?>
    ...
    <div id="right_column">
      <div class="holder">
        ...
        <div class="imgholder"><a href="../science/index.php"><img src="../../images/sciencelogo.jpg" alt="" height="90" width="240" /></a></div>
        
        <div class="imgholder"><a href="../bahasamelayu/index.php"><img src="../../images/bahsamelayulogo.png" alt="gambar bm" height="90" width="240" /></a></div>
