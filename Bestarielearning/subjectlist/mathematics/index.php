...
<div class="wrapper row4">
  <div id="quicknav" class="clear">
    <a href="../index.php" ><img src="../../images/back.png" width="110" height="34"  /> </a>|&nbsp;&nbsp;MATHEMATICS</div>
</div>
<!-- ####################################################################################################### -->
<div class="wrapper row5">
  <div id="container" class="clear"> 
    <!-- ####################################################################################################### --><!-- ############ -->
    <div id="content">
      <div class="imgholder"><img src="../../images/mathematicslogo.jpg" alt=""  height="215" width="645"/></div>
     <br />

       <?php
   $get=mysql_query("SELECT DISTINCT chapter FROM notes WHERE subject ='Mathematics'");
    $option = '';
...
if(isset($_POST['showall']))
  {
  $sql = "SELECT * FROM notes WHERE subject = 'Mathematics'";
...
if(isset($_POST['srch']))
{
  ...
  {
  $sql = "SELECT * FROM notes WHERE chapter = '$chpter' AND subject ='Mathematics'";
  $rs_result = mysql_query($sql);
  }
}
