...
<div class="wrapper row4">
  <div id="quicknav" class="clear">
    <a href="../index.php" ><img src="../../images/back.png" width="110" height="34"  /> </a>|&nbsp;&nbsp;BAHASA MELAYU</div>
</div>
<!-- ####################################################################################################### -->
<div class="wrapper row5">
  <div id="container" class="clear"> 
    <!-- ####################################################################################################### --><!-- ############ -->
    <div id="content">
      <div class="imgholder"><img src="../../images/bahsamelayulogo.png" alt="BAHSA MELAYU"  height="215" width="645"/></div>
     <br />

    
       <?php
   $get=mysql_query("SELECT DISTINCT chapter FROM notes WHERE subject ='Bahasa Melayu'");
    $option = '';
...
<table width="100%" summary="Summary Here" cellpadding="0" cellspacing="0">
        <thead>
          <tr>
          <th width="8%">No. </th>
...
if(isset($_POST['showall']))
  {
  $sql = "SELECT * FROM notes WHERE subject = 'Bahasa Melayu'";
...
if(isset($_POST['srch']))
{
  ...
  {
  $sql = "SELECT * FROM notes WHERE chapter = '$chpter' AND subject ='Bahasa Melayu'";
  $rs_result = mysql_query($sql);
  }
}
   ...
   ?>
    ...
    <div id="right_column">
      <div class="holder">
        ...
        <div class="imgholder"><a href="../mathematics/index.php"><img src="../../images/mathematicslogo.jpg" alt="gmba bm" height="90" width="240" /></a></div>
        
        <div class="imgholder last"><a href="../science/index.php"><img src="../../images/sciencelogo.jpg" height="90" width="240" alt="" /></a></div>
      </div>
    </div>
    <!-- ####################################################################################################### --> 
  </div>
