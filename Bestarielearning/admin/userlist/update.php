...
$sql = "SELECT * FROM users WHERE IC ='$upd'";
...
<div class="wrapper row4">
  <div id="quicknav" class="clear">
    <a href="index.php" ><img src="../../images/back.png" width="110" height="34"  /> </a>|&nbsp;&nbsp;UPDATE ACCOUNT</div>
</div>
<!-- ####################################################################################################### -->
...
<strong>Name:</strong><br />
     ...
     <br />
      ...
      <br />
         ...
         <input name="UPDATE" class="button" type="submit" value="Update Info"/> &nbsp;&nbsp;&nbsp;&nbsp;
...
$sql1="UPDATE users SET IC='$ic', Password = '$pwd', Name = '$name', Address='$address', PhoneNo='$nophone' , Email='$email' WHERE IC ='$upd' ";
