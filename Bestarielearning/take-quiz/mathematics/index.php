...
<div class="wrapper row4">
  <div id="quicknav" class="clear"> <a href="../index.php" ><img src="../../images/back.png" width="110" height="34"  /> </a>|MATHEMATICS QUIZ CHAPTER <?php echo $chapterrr;?><input name="cate" type="hidden" value="<?php echo $chapterrr;?>" /></div>
</div>
<!-- ####################################################################################################### -->
...
$chapterrr=$_POST['chapterr'];
$questionNumber = 1;
$query = mysql_query("SELECT * FROM quiz WHERE chapter = '$chapterrr' AND subject ='Mathematics' ORDER BY RAND()");
