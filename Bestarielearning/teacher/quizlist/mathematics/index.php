...
<div class="wrapper row4">
  <div id="quicknav" class="clear"><a href="../index.php" ><img src="../../../images/back.png" width="110" height="34"  /> </a>|&nbsp;&nbsp;MATHEMATICS QUIZ  
...
<!--==============================================================-->   
  <?php
   $get=mysql_query("SELECT DISTINCT chapter FROM quiz WHERE subject ='Mathematics'");
    $option = '';
...
?>
 ...
 <th width="5%">Edit/Delete</th>
  ...
  {
  $sql = "SELECT * FROM quiz WHERE subject = 'Mathematics'";
  ...
  $sql = "SELECT * FROM quiz WHERE chapter = '$chpter' AND subject ='Mathematics'";
  $rs_result = mysql_query($sql);
  }
