...
<div class="wrapper row4">
  <div id="quicknav" class="clear"><a href="../index.php" ><img src="../../../images/back.png" width="110" height="34"  /> </a>|&nbsp;&nbsp;ENGLISH QUIZ  
...
<!--==============================================================-->   
  <?php
   $get=mysql_query("SELECT DISTINCT chapter FROM quiz WHERE subject ='English'");
    $option = '';
...
?>
 ...
 <th width="5%">Edit/Delete</th>
  ...
  {
  $sql = "SELECT * FROM quiz WHERE subject = 'English'";
  ...
  $sql = "SELECT * FROM quiz WHERE chapter = '$chpter' AND subject ='English'";
  $rs_result = mysql_query($sql);
  }
