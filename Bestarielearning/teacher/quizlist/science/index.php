...
<div class="wrapper row4">
  <div id="quicknav" class="clear"><a href="../index.php" ><img src="../../../images/back.png" width="110" height="34"  /> </a>|&nbsp;&nbsp;SCIENCE QUIZ  
...
?>
 ...
 <th width="5%">Edit/Delete</th>
  ...
  {
  $sql = "SELECT * FROM quiz WHERE subject = 'Science'";
  ...
  $sql = "SELECT * FROM quiz WHERE chapter = '$chpter' AND subject ='Science'";
  $rs_result = mysql_query($sql);
  }
