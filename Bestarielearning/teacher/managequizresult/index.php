...
<div id="topnav">
    <ul>
	  ...
	  <li   class="active"><a href="../../teacher/managequizresult/index.php"><strong>Manage Student Result</strong></a></li>
...
<div class="wrapper row4">
  <div id="quicknav" class="clear"><a href="../../index.php" ><img src="../../images/back.png" width="110" height="34"  /> </a>|&nbsp;&nbsp;MANAGE QUIZ RESULT
...
<div class="wrapper row5">
  ...
  <form method="post" action="">
   <h1>Search by student name : 
     <input name="searchtxtbox" type="text"   size="35"/> <input name="srch" class="button" type="submit" value="Search"/></h1>
  
   <input name="englishlist" type="submit" class="button" id="englishlist" value="English"/>&nbsp;&nbsp;
   <input name="mathematicslist" type="submit" class="button" id="mathematicslist" value="Mathematics"/>&nbsp;&nbsp;
   <input name="sciencelist" type="submit" class="button" id="sciencelist" value="Science"/>&nbsp;&nbsp;
      <input name="bahasalist" type="submit" class="button" id="bahasalist" value="Bahasa Melayu"/>&nbsp;&nbsp;
  ...
  {
  $sql = "SELECT * FROM quizscore WHERE   subject ='English'" ;
 ...
 //=========================================================
  ...
  $sql = "SELECT * FROM quizscore WHERE   subject ='Mathematics'";
  $rs_result = mysql_query($sql);
  }
//========================================================= 
 ...
 //=========================================================
  ...
  $sql = "SELECT * FROM quizscore WHERE  subject ='Science'";
  $rs_result = mysql_query($sql);
 ...
 //=========================================================
  ...
  $sql = "SELECT * FROM quizscore WHERE  subject ='Bahasa Melayu'";
  $rs_result = mysql_query($sql);
 ...
 //=========================================================
  ...
  $sql = "SELECT * FROM quizscore WHERE user LIKE '%$usrname%'";
  $rs_result = mysql_query($sql);
